...
public class GestorDeEvolucion implements Operaciones {
    ...
    public ArrayList<Individuo> seleccion(int numIndividuos) {
        ...
        for (int i = 0; i < this.tamañoPoblacion; i++) {
            acu = acu + this.poblacion.get(i).getFitness() / fitnessTotal();
    ...
    public double fitnessPromedio() {
        ...
        for (int i = 0; i < this.tamañoPoblacion; i++) {
            fitnessPromedio = fitnessPromedio + this.poblacion.get(i).getFitness();
        }
    ...
    public double fitnessTotal() {
        ...
        for (int i = 0; i < this.tamañoPoblacion; i++) {
            fitnessTotal = fitnessTotal + this.poblacion.get(i).getFitness();
        }
        return fitnessTotal;
    }
...
//        System.out.print("\n");
    ...
    public Individuo getTheBest(){
        ...
        for (int i = 0; i < this.tamañoPoblacion; i++) {
            if(mejor<this.poblacion.get(i).getFitness()){
                mejor = this.poblacion.get(i).getFitness();
